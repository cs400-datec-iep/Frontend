...
function newPassword() {
  ...
  var urlChangeFirstLoginBool =
    urlMain + "api/Account/FirstLogin/" + sessionStorage.getItem("userID");
  ...
  if (password == "" || oldpassword == "" || confirmPassword == "") {
    ...
    fetch(urlPostPasswordChange, {
      ...
      .then(function(a) {
        if (a.status == 400) {
          alert(
            "Passwords must contain: An uppercase character, a lowercase character, a number and a symbol."
          );
        } else {
