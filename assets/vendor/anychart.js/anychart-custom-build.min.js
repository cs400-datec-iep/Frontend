 ...
 *
 * Modules: anychart-pert
 * Version: 8.7.0 (2019-10-29)
...
c=a?this.NI():"AnyChart - JavaScript Charts designed to be embedded and integrated{{anychart-version}}",$.me(this.g,{href:a?this.QI():"https://www.anychart.com/?utm_source=trial",title:c.replace("{{anychart-version}}",b),target:"_blank"}),$.me(this.b,{alt:a?this.OI():"AnyChart - JavaScript Charts"}),this.I(Mk));this.J(Nk)&&(a=a?this.text():"Anychart: Project Blueprint",$.Ne(this.D,a),this.I(Nk));if(this.J(Ok)){if(a=Sk(this)?this.AE():Qk()){if(this.O=a,b=Tg($.Uf()))$.Bd(b,"complete",this.r1,!1,this),$.Bd(b,
...
$_=window.anychart;$_.$=$;$_._=_});anychart.licenseKey(' s11133007@student.usp.ac.fj-d1958230-df657dbc');