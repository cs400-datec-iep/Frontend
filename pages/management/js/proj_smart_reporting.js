  ...
  fetch(urlGetAllTasks, {
    ...
    .then(function(j) {
      ...
      if (j.length == 0) {
        ...
        document
          .getElementById("task_complete_chart")
          .classList.toggle("d-none");
        document.getElementById("active-no-data").classList.toggle("d-none");
        document
          .getElementById("task_active_inactive_chart")
          .classList.toggle("d-none");
        document
          .getElementById("percentage-no-data")
          .classList.toggle("d-none");
        document
          .getElementById("task_percentage_chart")
          .classList.toggle("d-none");
      }
      ...
      function drawBasic() {
        ...
        var chart = new google.charts.Bar(
          document.getElementById("task_percentage_chart")
        );
      ...
      function drawPie() {
        ...
        var chart = new google.visualization.PieChart(
          document.getElementById("task_complete_chart")
        );
      ...
      function drawDoughnut() {
        ...
        var chart = new google.visualization.PieChart(
          document.getElementById("task_active_inactive_chart")
        );
        chart.draw(data, options);
      }
