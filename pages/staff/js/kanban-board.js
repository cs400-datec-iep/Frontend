      ...
      function(require, module, exports) {
        ...
        dragula([$("todo"), $("doing"), $("done")], {
          accepts: function(target, source, el) {
            if (target.id == "Locked") {
              //Task with predecessor cant be placed into any containers
              return false;
            } else if (el.id == "todo" && source.id == "done") {
              //Cant place tasks from Todo directly to Done
              return false;
            } else if (el.id == "doing" && source.id == "todo") {
              //Cant place tasks from Doing directly to Todo
              return false;
            } else if (el.id == "done" && source.id == "doing") {
              //Cant place tasks from Done directly to Doing
              return false;
            } else if (el.id == "done" && source.id == "todo") {
              //Cant place tasks from Done directly to Todo
              return false;
            }
            return true;
          }
